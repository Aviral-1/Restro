...
async function seed() {
  ...
  console.log('✅ Subscription Plans created dghsdrfghdf hdfhdf sgsgsgsg hdfhtfyhdtghysdryhg  dfghdh dthdtyhftghfcg dfvbefbdfh bd  fxdshedth jhfkyo oiyfrouifyouifyo i ');

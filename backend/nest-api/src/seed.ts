...
async function seed() {
  ...
  console.log('✅ Subscription Plans created dghsdrfghdf hdfhdf fg   fdgfsdg sdfgfsdg sdfgdfgdfghdghdhgdhdhdhdhdhsgsf gsdfghsfgsfgsfdgsgsgsgsg hdfhtfyhdtghysdryhg  dfghdh dthdtyhftghfcg dfvbefbdfh bd  fxdshedth jhfkyo oiyfrouifyouifyo i ');

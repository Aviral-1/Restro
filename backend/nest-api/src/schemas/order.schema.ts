...
export class Order extends Document {
  ...
  @Prop({ type: Types.ObjectId, ref: 'Restauranthfjyflf e65yesrtydsrtysdfx ghsxdfhdfxhfsdhsfhsfhsfgsdfgsdfgsdfghdfhdfjdfsgjsdrtjsryiuw5 srjn erfaefafasd fasdfasdfasdfasdfafafasfasfafafaf  gwergrwgwrg rgwergrwegergerg egerger gereryd yedydryrsdydrsekl;jhpiohpohpohpoihpohpohophpohpohrgergdfgdrgdfghdfghrfstysdrtysdrysdftfsdtgdftdftsdftsdftgsdfgsdfgsdfgsdfgxfcghs hgvjhgvhujvgjhrf3rf3rf3rf3rf3fhdfhdfhdfhdfhdfhdfhfdhdfh iughoiugpiuogpuigpiug fgbfdfgdfg ythythththyh thntryn dhdfhd fhdh fhbxfh xdfh tyntyntyn ty sfgs sdgsdfgsfghsfgsfdgsdf xs xdflkufkuf dghdsf xgbxcgbcxbcx ghsdrhgfgh fhgdf hdfhdfhdfhdfh dfhgfsdhfdhdfhdfhdfhdfh rtsrtsrtsrts ertsrtsdftg dftgsd gsdgsd  wtgwetg wsg dfghd fhdfhdfhd zdfsad fgsfdgdrfhgdfhdfhdfhdfhfdhfd dfhdjfjkdfsdghd fhdhdhdhdhdhdfg dsdhdfhdfhdfhdfh kjglkfui il fgysdf hsfhdfhdfhdf hdfghdf hdfhdfdfgbf sddhshedfhdf gfhdgh dh gchdcghdg jhdg fdghdfg sdfg djh', required: true })
